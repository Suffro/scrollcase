...
- **The schemas are the source of truth for types.** They are generated (`npm run types` →
...
- `src/contract/types/index.d.ts` — generated. Regenerate with `npm run types`; never hand-edit.
