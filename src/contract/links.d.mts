 ...
 * @returns {boolean}
 */
export function isRelativeLinkTarget(target: unknown): boolean;
/**
 ...
 */
export function resolvePayloadLinkTarget(linkPath: string, target: string): string | null;
/**
 ...
 */
export function findEntryThroughLink(entries: Array<{
    path: string;
    kind: string;
}>): string | null;
/**
 ...
 */
export function findUnresolvableLink(entries: Array<{
    path: string;
    kind: string;
    linkTarget?: string;
}>): string | null;
 ...
 * @returns {boolean}
 */
export function targetCarriesLinks(platform: string): boolean;
/**
